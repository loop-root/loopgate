...
func activeModelEnvOverrides() []string {
	envNames := []string{
		"LOOPGATE_MODEL_PROVIDER",
		"LOOPGATE_MODEL_PROFILE",
		"LOOPGATE_MODEL_NAME",
		"LOOPGATE_MODEL_BASE_URL",
		"LOOPGATE_MODEL_CONNECTION_ID",
		"LOOPGATE_MODEL_API_KEY_ENV",
		"LOOPGATE_MODEL_TEMPERATURE",
		"LOOPGATE_MODEL_MAX_OUTPUT_TOKENS",
		"LOOPGATE_MODEL_TIMEOUT_SECONDS",
		"MORPH_MODEL_PROVIDER",
		"MORPH_MODEL_PROFILE",
		"MORPH_MODEL_NAME",
		"MORPH_MODEL_BASE_URL",
		"MORPH_MODEL_CONNECTION_ID",
