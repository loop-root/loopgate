...
func defaultFolderAccessPresets() []folderAccessPreset {
	return []folderAccessPreset{
		...
		},
		{
			...
			Warning:         "Morph reads and organizes files in place on your real Mac filesystem. All writes require Loopgate approval.",
		...
		},
		{
			...
			Warning:         "Desktop often contains transient or personal items. All writes require Loopgate approval.",
		...
		},
		{
			...
			Warning:         "Documents can contain sensitive material. All writes require Loopgate approval.",
