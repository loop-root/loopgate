...
**Threat model snapshot reviewed:** 2026-04-03. Re-validate after major transport, multi-tenant, Haven shell, or **out-of-tree IDE bridge** surface changes. (**In-tree MCP removed** — ADR 0010 — reducing subprocess/protocol attack surface; a future thin MCP forwarder would re-open review.)
