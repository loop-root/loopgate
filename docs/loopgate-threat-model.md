...
- Out of scope (this revision):
  ...
  - remote governance deployment beyond the current local-first Loopgate profile
...
- Explicit assumptions:
  ...
  - Continuity and memory concerns are out of scope for the active Loopgate kernel and should be modeled separately in the `continuity` repo.
...
- Operator client → future `morphui` bridge/browser
  ...
  - Evidence: [claude_code_hooks_mvp.md](design_overview/claude_code_hooks_mvp.md).
